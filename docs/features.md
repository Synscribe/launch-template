...
| Blog search/pagination/related content/feed  | Keep with blog            | Implemented for current Wisp content   | P2                       | Server-rendered search, pagination, related cards, and `/feed.xml`        |
| Blog tags                                    | Add when content has tags | Current Wisp source has no tags        | P2                       | Add only when the publication has a useful tag model                      |
