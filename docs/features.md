...
| Explicit `.md` sibling URLs                  | Add later                 | Not installed and non-blocking                                                                                             | P2                       | Add only when agents need alternate links as well as `Accept: text/markdown`; HTML stays canonical |
