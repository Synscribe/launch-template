...
| `llms.txt`                                   | Keep and replace          | Launch Template example, replacement/shape check, live response/target audit, and recipe     | P2                       | `public/llms.txt`, `docs/recipes/llms-txt.md`; generate from real sources   |
