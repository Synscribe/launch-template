...
| Blog search/pagination/related content/feed  | Keep with blog            | Implemented for current Wisp content                        | P2                       | Server-rendered search, numbered pagination, related cards, and `/feed.xml` |
