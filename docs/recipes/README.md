...
- [`use-cases.md`](use-cases.md): add validated JSON-backed detail pages or remove the entire default cleanly.
- [`blog.md`](blog.md): connect the Wisp-backed blog or remove its routes, feed, dependencies, and navigation.

## Planned with page phases

- Contact: accessible form, server validation, delivery adapter, attribution, privacy and abuse controls.

## Later add-ons

- animated route-local sections;
- generated visuals and asset handling;
- docs/knowledge base;
