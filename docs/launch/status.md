...
| Use cases          | Detail model built     | Deep website-migrations page and hub groups; index next   |
...
| SEO-05   | Pass for current routes             | Unassigned | Homepage and use-case detail listed by `src/app/sitemap.ts`            |
...
| ------------ | --------------------------------------------------------- | ---------- | ------------------------------------------------ |
| SEO-08       | WebSite schema on home; BreadcrumbList on use-case detail | Unassigned | `src/lib/seo.ts`                                 |
